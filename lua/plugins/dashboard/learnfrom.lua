-- adapted from https://github.com/crivotz/nv-ide/blob/master/lua/plugins/alpha-nvim.lua
return {
  "goolord/alpha-nvim",
  event = "VimEnter",
  ...
  config = function()
    ...
    --- @param opts { cwd: string, items_number: number, ignore: fun(path: string, ext: string): boolean } optional
    --- @return string[]
